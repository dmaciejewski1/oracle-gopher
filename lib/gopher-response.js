...
"use strict";
var os = require('os');
var formatter = require('formattor');
...
//metrics-----------------------------------------------------------------------
  ...
  var avgCharsPerRow = function (){if(dbRowsReturned > 1){return Math.round((dbCharsReturned/dbRowsReturned)*100)/100;}else{return 0;}};
    var metrics = {
      ...
      "rowVelocity" : Math.round((dbRowsReturned/((endTimeID - startTimeID)/1000))*100)/100,
      "charVelocity" : Math.round((dbCharsReturned/((endTimeID - startTimeID)/1000))*100)/100
    };
